...
import type { IBankSchema } from '@modules/bank/presentation/schemas';
import { BankSchema } from '@modules/bank/presentation/schemas';
...
export class EditBankUseCase {
  ...
  static async handle(data: IBankSchema, id: number) {
